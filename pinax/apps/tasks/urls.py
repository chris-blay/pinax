...
urlpatterns = patterns("",
    ...
    url(r"^(?P<field>modified|state|assignee|tag|due)/(?P<value>[^/]+)/$", "pinax.apps.tasks.views.focus", name="task_focus"),
    ...
    url(r"^add_milestone/$", "pinax.apps.tasks.views.add_milestone", name="milestone_add"),
    url(r"^milestones/$", "pinax.apps.tasks.views.milestones", name="milestone_list"),
    url(r"^milestone/(?P<id>\d+)/$", "pinax.apps.tasks.views.milestone", name="milestone_detail"),
